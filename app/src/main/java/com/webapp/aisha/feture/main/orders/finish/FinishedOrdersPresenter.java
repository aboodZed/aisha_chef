...
public class FinishedOrdersPresenter {

    private Activity activity;
    private NavigationView view;
    private OrdersView ordersView;
    private String next_page_url = "agents/orders?status=finished";
    private boolean loadingMoreItems;

    public FinishedOrdersPresenter(Activity activity, NavigationView view, OrdersView ordersView) {
