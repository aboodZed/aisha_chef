package com.webapp.aisha.feture.main.orders.finish;
...
public class FinishedOrdersFragment extends Fragment implements OrdersView {

    @BindView(R.id.rv_orders) RecyclerView rvOrders;
    @BindView(R.id.fl_load_more) FrameLayout flLoadMore;

    private FinishedOrdersPresenter presenter;
    private OrdersAdapter adapter;
    private NavigationView view;

    public static FinishedOrdersFragment newInstance(NavigationView navigationView) {
        return new FinishedOrdersFragment(navigationView);
    }

    public FinishedOrdersFragment(NavigationView view) {
        this.view = view;
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_finished_orders, container, false);
        ButterKnife.bind(this, v);
        presenter = new FinishedOrdersPresenter(getActivity(), view, this);
        initRecycleView();
        return v;
    }
