...
public class NewOrderPresenter {
    ...
    public NewOrderPresenter(Activity activity, NavigationView view, OrderView orderView) {
    ...
    public void setOrderReady(Order order) {
        orderView.showDialog(activity.getString(R.string.order_accept));
        ApiShared.getInstance().getOrderData().setPreparing(activity, order.getId(),
